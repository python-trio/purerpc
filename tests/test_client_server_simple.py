...
from purerpc.test_utils import run_grpc_service_in_process, run_purerpc_service_in_process, run_tests_in_workers


def test_purerpc_server_grpc_client():
...
def test_grpc_server_purerpc_client():
...
def test_purerpc_server_purerpc_client():
    service = Service("Greeter")
